    ...
    if label in ["half_cheetah", "HalfCheetah-v2"]:
        ...
        if partitioning == "2x3":
            parts = [(bfoot, bshin, bthigh),
                     (ffoot, fshin, fthigh)]
        elif partitioning == "2|4":
            parts = [(bfoot, bshin),
                     (bthigh, ffoot, fshin, fthigh)]
        elif partitioning == "4|2":
            parts = [(bfoot, bshin, bthigh, ffoot),
                     (fshin, fthigh)]
        ...
        if partitioning == "3x1":
            parts = [(thigh_joint,),
                     (leg_joint,),
                     (foot_joint,)]
        elif partitioning == "2|1":
            parts = [(thigh_joint,leg_joint),
                     (foot_joint,)]
        ...
        if partitioning == "2x3":
            ...
            parts = [(thigh_left_joint, thigh_joint),
                     (foot_left_joint, leg_left_joint, foot_joint, leg_joint)]
        elif partitioning == "3x2":
            parts = [(foot_joint, foot_left_joint), (leg_joint, leg_left_joint),(thigh_joint, thigh_left_joint,)]
